def read_recording(filename, recording_start=0, recording_len=30*60):
    ...
    array_wide_spikes_per_second = pd.cut(data_points["t"], bins=recording_len, precision=0)
    # print(spikes.value_counts())
    ...
    f.close
    return (spikes, spikes_per_array, array_wide_spikes_per_second)
