...
class CA_neuron_model:
    def __init__(self, comparing_file = None, n = int(m.sqrt(SMALL)), p = 0.3,neighbor_width = 1,spont_p = 0.0001,reset_n = 20,initial_p = 0.01, steps = 1800):
